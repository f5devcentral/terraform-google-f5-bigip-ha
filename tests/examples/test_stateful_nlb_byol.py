...
def fixture_output(
    ...
    license_keys_retriever: Callable[[str], list[str]],
    subnet_self_links: list[str],
) -> Generator[dict[str, Any]]:
    """Create the example resources."""
    with run_tf_in_workspace(
        fixture=fixture_dir(name=fixture_name, example_name="stateful-nlb-byol"),
        tfvars={
            "name": fixture_name,
            ...
            "license_keys": license_keys_retriever(FIXTURE_NAME),
            "metadata": {
